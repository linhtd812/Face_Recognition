...
def recognize(mode, parameters):
    ...
    if input_type == "w":
        ...
        if save_video:
            ...
            output_video = cv2.VideoWriter("/media/linh/hdd4TA/Automated-Attendance-System-using-CNN-master/output_recognition/Output_" + data_type, video_format, fps, frame_size)
